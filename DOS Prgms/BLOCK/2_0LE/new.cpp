...
Animal_struct	man, devil;		// two animals
...
int	new_hs = -1;				// index 0-9 of new high score, -1 = none
int	animals = 0;				// animals on screen?
...
// accordingly.
{
   ...
   if (pos >= 0)								// if valid insertion point (new hs)...
   {
      ...
      cprintf("Enter your name:");
		...
		strcpy(hs_list[pos].name, one_word(get_string(29,12,17,LOCK,SHOW,CASE)));
